...
public class VersionAggregator extends BaseDatabasesDocAggregator {

    private DataHelper dataHelper = new DataHelper();

    public VersionAggregator(InventoryReport inventoryReport) {
        super(inventoryReport);
    }

    @Override
    public InventoryReport.Column column() {
        return InventoryReport.Column.VERSION;
    }

    @Override
    public void handleSheetDoc(Document doc) {
        dataHelper.addData(doc.get(Context.Field.MOD_ID), doc.get(Context.Field.VERSION_NAME));
    }
